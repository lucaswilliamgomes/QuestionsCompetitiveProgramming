...
long double disttolineOtherForm(point p, double a, double b, double c) { // distancia do ponto a reta
	return abs(a * p.x + b * p.y + c) / sqrt(a * a + b * b);
}

vector<int> getEquacaoDaReta(point p1, point p2) {
...
int main(int argc, char **argv)
{
    ...
    vector<int> ans = getEquacaoDaReta(p1, p2);
